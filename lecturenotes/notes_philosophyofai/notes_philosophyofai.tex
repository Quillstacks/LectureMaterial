...
\makeindex % index entries are present throughout all chapters; latexmk runs makeindex automatically
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\makeintroduction{%
  ...
  system causes harm, or for that matter is beneficial. \textbf{Agency} asks
  about the role and implications of autonomous decision-making, the concept of alignment and human oversight.
  \textbf{Embodiment} asks whether a physical
  presence changes the ethical stakes and responsibilities.
...
\input{chapters/03_Agency.tex}
\input{chapters/04_Embodiment.tex}
...
\makestandardbackmatter{philosophyofai_references}
