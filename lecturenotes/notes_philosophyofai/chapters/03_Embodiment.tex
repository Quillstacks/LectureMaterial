...
\begin{enumerate}
    ...
    \marginnote{\newthought{Animal Ethics Parallel.} We already have a framework for embodied, non-verbal, non-human beings. 
    Singer\cite{singer1975animal} argues that capacity for suffering, not rationality or language, grounds moral consideration. 
    When a robot can be harmed, distressed, or worn down, animal ethics becomes the nearest map. Similar lines have been considered by 
    Asimov\cite{asimov1951foundation} and more recently by Gunkel\cite{gunkel2018robot}.}
