...
\newthought{Large Language Models} (LLMs)\index{Large Language Models} create an illusion of sentience by producing coherent, context-aware text. 
...
\marginnote{%
    \bibentry{hoffmann1816sandmann}%
}%
\begin{tabular}{p{3.8cm} p{6.5cm}}
    \textbf{Required reading} &
        \textit{Der Sandmann}\index{Der Sandmann}\index{Hoffmann, E. T. A.} by E.T.A.\ Hoffmann
...
\noindent Read \textit{Der Sandmann} before the session. Work through the
...
\begin{enumerate}
    ...
    entity is \textbf{almost} but not quite human. Have you experienced
...
\medskip
\newthought{Turing Test.}\index{Turing Test}\index{Turing, Alan} Turing\cite{turing1950computing}: if
...
\marginnote{\newthought{Uncanny Valley.}\index{Uncanny Valley}\index{Mori, Masahiro} Mori\cite{mori2012uncanny}: humanoid objects that are \textbf{almost} but not quite human elicit eeriness, the ``valley'' is the dip in emotional response just before full human likeness.}
...
\marginnote{\newthought{Informed Consent.}\index{Informed consent} Users should be fully aware
...
\medskip
\noindent\textbf{Bentham's Test.}\index{Bentham, Jeremy} ``The question is not, Can they
...
Legal personhood\index{Legal personhood}\index{Moral status} and moral status are distinct questions. A system can merit legal recognition without having interests,
