...
\marginnote{\newthought{Uncanny Valley.} Mori\cite{mori2012uncanny}: humanoid objects that are \textbf{almost} but not quite human elicit eeriness, the ``valley'' is the dip in emotional response just before full human likeness.}
