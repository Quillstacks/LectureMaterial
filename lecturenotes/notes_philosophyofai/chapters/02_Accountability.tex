...
\newthought{The Responsibility Gap}\index{Responsibility gap}
...
\marginnote{%
    ...
    \end{flushright}%
    \medskip
    \newthought{Minority Report}\index{Minority Report}\cite{spielberg2002minority} A
...
\newthought{Algorithmic governance}\index{Algorithmic governance} and black-box AI in high-stakes domains highlight
...
\begin{tabular}{p{3.8cm} p{6.5cm}}
    \textbf{Required reading} &
        \textit{In der Strafkolonie}\index{In der Strafkolonie}\index{Kafka, Franz}\cite{kafka1919strafkolonie} by Franz Kafka
...
\marginnote{\newthought{Risk-based regulation.}\index{Risk-based regulation} Obligations scale with the
...
\noindent The EU AI Act\index{EU AI Act}\cite{euaiact2024} is the first comprehensive
...
\noindent\textbf{The Regulator} argues that whoever profits from and
    ...
    \begin{itemize}
        ...
        the system builds a moral crumple zone\index{Moral crumple zone}\cite{elish2019crumple}: a
...
or a trained agent, whose makers answer for its formation? Explainability\index{Explainability}, the
...
have no human willing to own its outputs. Meaningful human control\index{Meaningful human control}, a
