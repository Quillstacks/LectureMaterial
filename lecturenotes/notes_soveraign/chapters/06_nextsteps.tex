...
new client of the Ollama you already run or a new tenant on the same GPU, so none requires
starting over.
...
\begin{itemize}
    ...
    like any other, lets Ollama read images, screenshots, diagrams, and scanned
    ...
    older web UIs and shares the card with Ollama\cite{comfyuiRepo}.
    ...
    on the same Ollama your terminal already talks to.
...
\newthought{What you now own} is a machine in a room and a stack you understand
