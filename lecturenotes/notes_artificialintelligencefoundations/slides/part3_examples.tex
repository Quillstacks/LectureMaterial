...
\begin{frame}{Maps}
  \panel{two phones, the delta and the route}
...
\begin{frame}{Self-driving Cars}
  \panel{the unforeseen circumstance}
...
\begin{frame}{Identifying Images}
  \panel{rifle 2017 next to Picasso 1910}
...
\begin{frame}{Emotional AI}
  \panel{ten per cent of the message}
...
\begin{frame}{Exoskeletons}
  \panel{elderly man or firefighter}
