...
\begin{frame}{Overall Human-Machine Intelligence}
  \panel{the smartphone as marketplace}
...
\begin{frame}{Feminism}
  \panel{Ada Lovelace and Grace Hopper}
...
\begin{frame}{Digital Capitalism}
  \panel{Weber's judge and Marx's worker}
