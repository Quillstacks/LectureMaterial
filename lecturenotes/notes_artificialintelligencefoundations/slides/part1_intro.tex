...
\begin{frame}{Our creatures have always turned against us}
  \panel{Golem, Frankenstein and the rubber boots}
...
\begin{frame}{Who is Julia}
  \panel{Julia, the digit wall and the 404}
...
\begin{frame}{Who is Lena}
  \panel{Lena, the iceberg of visual codes}
...
\begin{frame}{Lessons from AI in Fiction}
  \panel{the five fictional robots, 1927 to 2014}
  \panelslide{10}{1}{}
\end{frame}
\begin{frame}{Lessons from AI in Fiction}
  \panel{the five fictional robots, 1927 to 2014}
