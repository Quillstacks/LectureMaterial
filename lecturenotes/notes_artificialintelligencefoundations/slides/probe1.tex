...
\begin{document}
\section{Risks}
\setpagethesis{Five of the six asks are legislation, not engineering. \textup{---} Schneider and Ziyal}
...
\begin{frame}{Maps}
  ...
  \panelslide{21}{6}{The proprietary algorithms of Maps have access to vast amounts of data.}
\end{frame}
