...
% Introduction
\makeintroduction{%
  \newthought{This is an adaptation} of the MIT Missing Semester course material. 
  Well, by now it is that much adapted that it is basically an entirely novel thing, but the spirit and the motivation are the same.
  And oh boy, we need it here in Germany as well! In the Länd of the 
...
\input{chapters/02_git_github.tex}

% LECTURE 3: Package the Stack
%\input{chapters/03_dependencies_structure.tex}

% LECTURE 4: Integrate the Model
%\input{chapters/04_model_integration.tex}

% LECTURE 5: Build the Backend
%\input{chapters/05_apis_services.tex}

% LECTURE 6: Store the Data
%\input{chapters/06_databases_sql.tex}

% LECTURE 7: Expose to the World
%\input{chapters/07_frontend_nginx.tex}

% LECTURE 8: Ship It
%\input{chapters/08_cicd_automation.tex}

% LECTURE 9: Watch It Run
%\input{chapters/09_monitoring_logging.tex}

% LECTURE 10: Vibe Coding
%\input{chapters/10_ai_dev_vibecoding.tex}
