...
environment, installs dependencies, applies database migrations with
\texttt{alembic upgrade head}, restarts the systemd unit, and prints a
timestamped completion line.
...
installs dependencies, runs migrations, and restarts the service.
