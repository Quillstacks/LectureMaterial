...
At the end of this session, take a snapshot named \texttt{B8-complete}, your safety net for the next block.}
...
the database is dumped off-site. The next chapter shifts from automating the system to observing it,
collecting metrics, reading logs, and noticing when something is wrong before a user does.}
