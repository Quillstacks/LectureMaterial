...
Each theory section is followed by its exercise, so you can read a concept and
practise it immediately. At the end of the session, take a snapshot named
\texttt{B3-complete}, your safety net for the next block.}
...
Inside the PixelWise repository, create a shell script that captures the system
packages installed manually in Block~2:
