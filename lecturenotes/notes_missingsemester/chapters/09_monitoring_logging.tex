...
\newthought{Provided as boilerplate.} It returns prediction counts, average confidence, and model version
...
watching the system to scaling and hardening it. The next block carries that thread forward.
