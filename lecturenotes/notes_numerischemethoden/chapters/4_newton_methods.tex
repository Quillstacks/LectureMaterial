...
\begin{align*}
    ...
    &= 1.4 - \frac{1.344}{4.88} \approx 1.125 \\
    x_2 &= 1.125 - \frac{1.125^3 - 1.125}{3(1.125)^2 - 1} \\
    &\approx 1.125 - \frac{0.299}{2.797} \\
    &\approx 1.018 \\
    x_3 &= 1.018 - \frac{1.018^3 - 1.018}{3(1.018)^2 - 1} \\
    &\approx 1.018 - \frac{0.037}{2.109} \\
    &\approx 1.000
\end{align*}
...
\begin{align*}
    ...
    &= 1.4 - (1.344) \cdot \frac{1.4-1.2}{1.344 - 0.528} \\
    &= 1.4 - 1.344 \cdot \frac{0.2}{0.816} \\
    &\approx 1.4 - 0.329 \\
    &\approx 1.071 \\
    x_3 &= 1.071 - f(1.071) \cdot \frac{1.071 - 1.4}{f(1.071) - f(1.4)} \\
     &\approx 1.071 - (0.157) \cdot \frac{-0.329}{0.157 - 1.344} \\
     &\approx 1.071 - 0.157 \cdot \frac{-0.329}{-1.187} \\
     &\approx 1.071 - 0.157 \cdot 0.277 \\
     &\approx 1.071 - 0.043 \\
     &\approx 1.028
\end{align*}
...
Then continue to experiment with different starting points, and observe the
