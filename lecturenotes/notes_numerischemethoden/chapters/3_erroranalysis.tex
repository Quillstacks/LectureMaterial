...
\begin{align*}
    s^{+}_{h=1, x=-1} \cdot |\tilde{x} - x| &= |\hat{f}_1(-0.75) - \hat{f}_1(-1)| \\
    &= |\hat{f}_1(-1) - \hat{f}_1(-1)| \text{ see A)} \\
    &= 0 \\
    s^{+}_{h=1, x=-1} &= 0 \div 0.25 \\
    &\approx 0 \\[1em]
    s^{-}_{h=1, x=-1} \cdot |\tilde{x} - x| &= 0 \\
    s^{-}_{h=1, x=-1} &\approx 0
\end{align*}
...
\begin{align*}
    s^{+}_{h=0.2, x=-1} \cdot |\tilde{x} - x| &= |\hat{f}_{0.2}(-0.75) - \hat{f}_{0.2}(-1)| \\
    &= |\hat{f}_{0.2}(-0.8) - \hat{f}_{0.2}(-1)| \\
    &= |-0.71736 - (-0.84147)| \\
    &= 0.12411 \\
    s^{+}_{h=0.2, x=-1} &= 0.12411 \div 0.25 \\
    &\approx 0.4964 \\[1em]
    s^{-}_{h=0.2, x=-1} \cdot |\tilde{x} - x| &= |\hat{f}_{0.2}(-1.25) - \hat{f}_{0.2}(-1)| \\
    &= |\hat{f}_{0.2}(-1.2) - \hat{f}_{0.2}(-1)| \\
    &= |-0.93204 - (-0.84147)| \\
    &= 0.09057 \\
    s^{-}_{h=0.2, x=-1} &= 0.09057 \div 0.25 \\
    &\approx 0.3623
\end{align*}
\marginnote{\newthought{Border regions.} The two directions bracket the stability constant, so $0.3623 \leq s_{h=0.2, x=-1} \leq 0.4964$.
