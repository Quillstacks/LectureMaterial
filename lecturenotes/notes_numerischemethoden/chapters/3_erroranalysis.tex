...
For the discretization with step size $h=1$, the method is stable as small changes in $\tilde{x}$ lead to small changes in the computed values of $\hat{f}(\tilde{x})$.
...
For $h=1$:
\begin{align*}
    s_{h=1, x=-1} \cdot |\tilde{x} - x| &= |\hat{f}(\tilde{x}) - \hat{f}(x)| \\
    &= |\hat{f}_1(-0.75) - \hat{f}_1(-1)|\\ 
...
For $h=0.2$:
\begin{align*}
    s_{h=0.2, x=-1} \cdot |\tilde{x} - x| &= |\hat{f}(\tilde{x}) - \hat{f}(x)| \\
    &= |\hat{f}_{0.2}(-0.75) - \hat{f}_{0.2}(-1)| \\
...
\begin{align*}
    ...
    &\geq \left| \hat{f}_{1}(-1) - f(-\frac{\pi}{2}) \right| \\
...
\begin{align*}
    ...
    &\geq \left| \hat{f}_{0.2}(-1.2) - f(-\frac{\pi}{2}) \right| \\
...
For $h=1$:
\begin{align*}
    \left| \hat{f}_1(\tilde{x}) - f(x) \right| 
    \left| \hat{f}_1(-1) - f(-\frac{\pi}{2}) \right| \\
    \left| \hat{f}_1(-0.75) - f(-\frac{\pi}{2}) \right| \\
    \left| \hat{f}_1(-1) - f(-\frac{\pi}{2}) \right| \\
...
For $h=0.2$:
\begin{align*}
    \left| \hat{f}_{0.2}(\tilde{x}) - f(x) \right| 
    \left| \hat{f}_1(-1.2) - f(-\frac{\pi}{2}) \right| \\
    \left| \hat{f}_{0.2}(-0.95) - f(-\frac{\pi}{2}) \right| \\
    \left| \hat{f}_{0.2}(-1) - f(-\frac{\pi}{2}) \right| \\
    \left| -0.84147 - (-1) \right| \\
    = 0.1599
\end{align*}
