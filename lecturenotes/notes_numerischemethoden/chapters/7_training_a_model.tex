...
\newthought{The model} is a univariate linear regression of Nobel laureates on chocolate consumption (Figure~\ref{fig:chocolate_nobel_scatter}), fit by gradient descent on the mean squared error. The seven correspondences below are illustrated against this model and dataset.
