...
% - Check chapters for NTH nices to haves and decide on whether to do them.

% - Think about how to integrate the code better into the lecture. The notebooks did not work as intended - Maybe think playground and sandboxes instead? For short hands-on experiences? 
...
\input{chapters/4_newton_methods.tex}
\input{chapters/5_global_optimization.tex}
\input{chapters/6_integration_and_sgd.tex}
%\input{chapters/7_numerical_stability.tex}
