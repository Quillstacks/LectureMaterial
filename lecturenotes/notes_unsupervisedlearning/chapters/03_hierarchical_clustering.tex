...
\printchapterversion{03_hierarchical_clustering}
...
\marginnote{$\|\cdot\|^2$ is a squared norm, not a Euclidean distance. Ward's values are variance increases; 
single and average linkage values are distances. The scales are not comparable.}
