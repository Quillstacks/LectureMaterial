...
\printchapterversion{08_zero_few_shot_transfer}
...
\begin{itemize}
    ...
    \item adapt pretrained representations efficiently, without paying full retraining cost.\index{PEFT}\index{fine-tuning}\marginnote{\newthought{LoRA}\cite{Hu2021LoRA} factors the correction as two thin matrices that slot onto a frozen layer. With $W$ frozen, $\partial L / \partial W$ is never formed and Adam's optimiser state collapses onto the rank-$r$ adapters. Fine-tuning just got cheap.}
