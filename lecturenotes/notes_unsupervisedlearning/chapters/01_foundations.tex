...
\marginnote{$C_1 = (300,\;7)$\\$C_2 = (500,\;6)$\\$C_3 = (700,\;3)$\\[4pt]daily cups sold, customer rating (1--10)}
...
\begin{align*}
    d_E(C_1, C_2) &= \sqrt{(500{-}300)^2 + (6{-}7)^2} = \sqrt{40\,000 + 1} \approx 200.0 \\
    d_E(C_2, C_3) &= \sqrt{(700{-}500)^2 + (3{-}6)^2} = \sqrt{40\,000 + 9} \approx 200.0
\end{align*}
...
\begin{align*}
    d(C_1', C_2') &= \sqrt{(0{-}({-}1))^2 + (0.32{-}0.80)^2} = \sqrt{1 + 0.23} \approx 1.11 \\
    d(C_2', C_3') &= \sqrt{(1{-}0)^2 + ({-}1.12{-}0.32)^2} = \sqrt{1 + 2.07} \approx 1.75
\end{align*}
