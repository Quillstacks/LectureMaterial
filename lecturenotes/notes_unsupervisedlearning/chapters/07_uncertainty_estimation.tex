...
\begin{itemize}
    ...
    \item Use uncertainty estimates to detect anomalies and out-of-distribution inputs via reconstruction, density, and energy-based scores.
...
\newthought{Anomaly detection} asks whether individual observations deviate from a learned notion of normal.
...
\begin{itemize}
    ...
    \item Anomaly detection applies uncertainty reasoning through statistical, proximity-based, and reconstruction-based scores; the type of anomaly---point, contextual, or collective---determines which method is appropriate.
    ...
    \item Graceful degradation---confidence thresholds, human handoff, fail-safe defaults, and distribution-shift monitoring---turns uncertainty estimates into a practical safety net.
\end{itemize}
