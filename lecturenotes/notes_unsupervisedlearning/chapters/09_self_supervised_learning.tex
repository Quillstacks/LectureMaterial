...
\printchapterversion{09_self_supervised_learning}
...
\marginnote{\newthought{DINO}\cite{Caron2021DINO} predates and inspires the JEPA family. A momentum teacher produces soft targets in feature space, the student matches them with cross entropy, and no negatives or labels are needed. Self-supervised attention maps emerge that segment objects without supervision.}
